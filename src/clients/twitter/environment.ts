import { ActionTimelineType, parseBooleanFromText, type IAgentRuntime } from '@elizaos/core'
  ...
  try {
    const twitterConfig = {
      ...
      ACTION_TIMELINE_TYPE:
        runtime.getSetting('ACTION_TIMELINE_TYPE') || process.env.ACTION_TIMELINE_TYPE
    }
